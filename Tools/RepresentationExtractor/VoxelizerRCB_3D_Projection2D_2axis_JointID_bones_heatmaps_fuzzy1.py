...
class VoxelizerRCB_3D_Projection2D_2axis_JointID_bones_heatmaps_fuzzy1(MirroirableVoxelization):
    ...
    def __init__(self, sizeBoxInit, thresholdToleranceCuDi, threshCurviDist, jointSelected, morphology: Morphology):
        super(VoxelizerRCB_3D_Projection2D_2axis_JointID_bones_heatmaps_fuzzy1, self).__init__(sizeBoxInit,
    ...
    def extractRepresentation(self, data: List[Posture]) -> Tuple[List[np.array], List[int]]:
        ...
        while postureID < len(data):
            ...
            stdDev = 1.3
            dist = 2 # before and after X/y of min/max coordinates, => bounding box with margin of "dist"
            ck = 1
            ...
            for j in range(len(self.jointSelected)):
                ...
                distance = 1.5 #around each joint
