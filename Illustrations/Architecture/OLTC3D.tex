...
\begingroup%
  ...
  \begin{picture}(1,0.97723766)%
    ...
    \put(0,0){\includegraphics[width=\unitlength,page=1]{OLTC3D.pdf}}%
    \put(0.50005972,0.73589769){\makebox(0,0)[t]{\lineheight{1.25}\smash{\begin{tabular}[t]{c}OLT-C3D\\block\end{tabular}}}}%
    \put(0.50013717,0.93854088){\makebox(0,0)[t]{\lineheight{1.25}\smash{\begin{tabular}[t]{c}blank classes scores\end{tabular}}}}%
    ...
    \put(0.91893806,0.01355211){\color[rgb]{0,0,0.09411765}\makebox(0,0)[t]{\lineheight{1.25}\smash{\begin{tabular}[t]{c}t\end{tabular}}}}%
    \put(0.8157523,0.01355211){\color[rgb]{0,0,0.09411765}\makebox(0,0)[t]{\lineheight{1.25}\smash{\begin{tabular}[t]{c}t-1\end{tabular}}}}%
    \put(0.71273943,0.01355211){\color[rgb]{0,0,0.09411765}\makebox(0,0)[t]{\lineheight{1.25}\smash{\begin{tabular}[t]{c}t-2\end{tabular}}}}%
    \put(0,0){\includegraphics[width=\unitlength,page=2]{OLTC3D.pdf}}%
    \put(0.50005972,0.56852639){\makebox(0,0)[t]{\lineheight{1.25}\smash{\begin{tabular}[t]{c}OLT-C3D\\block\end{tabular}}}}%
    \put(0,0){\includegraphics[width=\unitlength,page=3]{OLTC3D.pdf}}%
    \put(0.50005972,0.40089713){\makebox(0,0)[t]{\lineheight{1.25}\smash{\begin{tabular}[t]{c}OLT-C3D\\block\end{tabular}}}}%
    \put(0,0){\includegraphics[width=\unitlength,page=4]{OLTC3D.pdf}}%
    \put(0.50005972,0.2655306){\makebox(0,0)[t]{\lineheight{1.25}\smash{\begin{tabular}[t]{c}OLT-C3D\\block\end{tabular}}}}%
    \put(0,0){\includegraphics[width=\unitlength,page=5]{OLTC3D.pdf}}%
