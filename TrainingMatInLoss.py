...
from Tools.LossesAndMetrics.LossesAndMetrics_CTC_CustomRec import lossCTCSimpleCustomRec, \
    ...
    lossCTCSimpleCustomRec_prior_cumputationMatrixInLoss
...
if config.useSegmentationGuidedCTC:
    if config.usePrior:
        lossForCTC = lambda y, t: config.weightCTCLoss * lossCTCSimpleCustomRec_prior_cumputationMatrixInLoss(y, t,
