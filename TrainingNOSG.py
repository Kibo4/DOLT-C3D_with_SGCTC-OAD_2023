...
config = {
    ...
    "useSegmentationGuidedCTC": False,
...
if resuming:
    ...
    try:
        wandbRecuperator.download_weights(modelName, pathLog)
...
if config.useSegmentationGuidedCTC:
    ...
    if config.usePrior:
        ...
        if config.useCTCLiu:
            ...
            lossForCTC = lambda t, p: config.weightCTCLoss * lossCTC_Simple_TF
...
# %%
initialEpoch = 0 if not resuming else epochToResume
